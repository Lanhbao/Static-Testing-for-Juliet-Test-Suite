...
public class CWE80_XSS__Servlet_URLConnection_66a extends AbstractTestCaseServlet
{
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        dataArray[2] = data;
        (new CWE80_XSS__Servlet_URLConnection_66b()).badSink(dataArray , request, response );
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        String[] dataArray = new String[5];
        dataArray[2] = data;
        (new CWE80_XSS__Servlet_URLConnection_66b()).goodG2BSink(dataArray , request, response );
    }
