...
Filename: CWE80_XSS__Servlet_getCookies_Servlet_22a.java
...
public class CWE80_XSS__Servlet_getCookies_Servlet_22a extends AbstractTestCaseServlet
{
    ...
    private void goodG2B1(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        data = (new CWE80_XSS__Servlet_getCookies_Servlet_22b()).goodG2B1Source(request, response);
