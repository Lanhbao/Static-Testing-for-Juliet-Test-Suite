...
public class CWE80_XSS__Servlet_connect_tcp_72a extends AbstractTestCaseServlet
{
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_connect_tcp_72b()).badSink(dataVector , request, response );
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        dataVector.add(1, data);
        dataVector.add(2, data);
        (new CWE80_XSS__Servlet_connect_tcp_72b()).goodG2BSink(dataVector , request, response );
    }
