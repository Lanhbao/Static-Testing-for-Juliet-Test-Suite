...
public class CWE80_XSS__Servlet_URLConnection_75a extends AbstractTestCaseServlet
{
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        try
        {
            ...
            (new CWE80_XSS__Servlet_URLConnection_75b()).badSink(dataSerialized , request, response );
        }
        catch (IOException exceptIO)
        {
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        try
        {
            ...
            outputObject.writeObject(data);
            byte[] dataSerialized = streamByteArrayOutput.toByteArray();
            (new CWE80_XSS__Servlet_URLConnection_75b()).goodG2BSink(dataSerialized , request, response );
        }
        catch (IOException exceptIO)
        {
            IO.logger.log(Level.WARNING, "IOException in serialization", exceptIO);
