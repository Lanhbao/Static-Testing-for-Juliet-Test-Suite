...
public class CWE80_XSS__Servlet_URLConnection_71a extends AbstractTestCaseServlet
{
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_URLConnection_71b()).badSink((Object)data , request, response );
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE80_XSS__Servlet_URLConnection_71b()).goodG2BSink((Object)data , request, response );
    }
